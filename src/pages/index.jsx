        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
              ...
              <p className="mb-4">
                <b>
                  Welcome to Rent Nest!<br></br>
                  As your trusted booking platform, <br></br>Rent Nest connects
                  you to a diverse range of accommodations for every budget,
                  whether for a weekend getaway or business trip. Enjoy seamless
                  booking as we help you find the perfect stay for your needs.
                </b>
              </p>
              <p>
          ...
          <div className="row justify-content-center text-center mb-5">
            <div className="col-md-7">
              ...
              <p data-aos="fade-up" data-aos-delay="100">
                <b>At Rent Nest</b>, we offer a wide range of room types
                satisfied every traveler’s needs. Whether you're need for cozy
                single rooms, spacious suites, family-friendly apartments, or
                luxurious penthouses, we have options to meet every style and
                budget. Discover a perfect space with us!
              </p>
            </div>
          </div>
          <div className="row">
        ...
        <div className="container">
          <div className="row justify-content-center text-center mb-5">
            <div className="col-md-7">
              ...
              <p data-aos="fade-up">
                Rent Nest offers versatile room rentals for all events—whether
                business meetings , weddings, or family gatherings. Let us
                provide the perfect space to make your occasion unforgettable!
              </p>
            </div>
          </div>
          <div className="row">
              ...
              <div className="media media-custom d-block mb-4 h-100">
                ...
                <div className="media-body">
                  ...
                  <p>
                    ...
                    it with the necessary regelialia. t is a paradisematic
